"use strict";
cc._RF.push(module, '92aa0x/wa5CyLK9ubt5U38L', 'Settings');
// script/logic/ui/Settings.ts
...
var Settings = /** @class */ (function (_super) {
    ...
    Settings.prototype.onToggleEffect = function (toggle) {
    ...
    Settings.prototype.onToggleSound = function (toggle) {
    ...
    Settings.prototype.onToggleLanguage = function (toggle) {
        var language = toggle.isChecked ? 'en' : 'zh';
        this.labEn.node.active = language == 'en';
        this.labZh.node.active = language == 'zh';
        i18nMgr_1.i18nMgr.setLanguage(language);
    };
    Settings.prototype.onBtnClose = function () {
        this.node.active = false;
    };
    __decorate([
        property(cc.Label)
    ], Settings.prototype, "labEn", void 0);
    __decorate([
        property(cc.Label)
    ], Settings.prototype, "labZh", void 0);
    __decorate([
        property(cc.Toggle)
    ], Settings.prototype, "toggleEffect", void 0);
    __decorate([
        property(cc.Toggle)
    ], Settings.prototype, "toggleSound", void 0);
    Settings = __decorate([
        ccclass
    ], Settings);
    return Settings;
