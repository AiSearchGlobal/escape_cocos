"use strict";
cc._RF.push(module, 'a9c10H1OHxH+KLxNLMn15Pe', 'VMCustom');
// script/framework/component/VMCustom.ts
...
var VMCustom = /** @class */ (function (_super) {
    ...
    VMCustom.prototype.checkComponentState = function () {
        ...
        if (!this._watchComponent) {
            Log_1.Log.error('未设置需要监听的组件');
            return;
        }
        if (!this.componentProperty) {
            Log_1.Log.error('未设置需要监听的组件 的属性');
            return;
        }
        if (this.componentProperty in this._watchComponent === false) {
            Log_1.Log.error('需要监听的组件的属性不存在');
            return;
        }
