"use strict";
cc._RF.push(module, '6b848/TkdZDtbmqUinm3ZWl', 'VMCompsEdit');
// script/framework/component/VMCompsEdit.ts
...
var MVCompsEdit = /** @class */ (function (_super) {
    ...
    MVCompsEdit.prototype.onLoad = function () {
        ...
        if (!CC_EDITOR) {
            ...
            Log_1.Log.error('you forget delete MVEditFinder,[path]', path);
        }
    };
