"use strict";
cc._RF.push(module, '21ad2LZoONL4bkCbIZSfGEe', 'xxtea');
// script/framework/lib/xxtea.ts

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.xxtea = void 0;
var xxtea = /** @class */ (function () {
    function xxtea() {
    ...
    //init function
    xxtea.prototype.initInstance = function () {
    };
    xxtea.prototype.btoa = function (str) {
    ...
    ;
    xxtea.prototype.atob = function (str) {
    ...
    ;
    xxtea.prototype.toBinaryString = function (v, includeLength) {
        var length = v.length;
        var n = length << 2;
        if (includeLength) {
            var m = v[length - 1];
    ...
    xxtea.prototype.toUint32Array = function (bs, includeLength) {
    ...
    xxtea.prototype.int32 = function (i) {
        return i & 0xFFFFFFFF;
    };
    ...
    xxtea.prototype.utf8Encode = function (str) {
        if (/^[\x00-\x7f]*$/.test(str)) {
            return str;
        }
        var buf = [];
    ...
    xxtea.prototype.utf8DecodeShortString = function (bs, n) {
    ...
    xxtea.prototype.utf8DecodeLongString = function (bs, n) {
        var buf = [];
    ...
    // n is UTF16 length
    xxtea.prototype.utf8Decode = function (bs, n) {
    ...
    xxtea.prototype.encryptToBase64 = function (data, key) {
    ...
    xxtea.prototype.decryptFromBase64 = function (data, key) {
        if (data === undefined || data === null || data.length === 0) {
            return data;
        }
        return this.decrypt(this.atob(data), key);
    };
    xxtea.prototype.strToHexCharCode = function (str) {
