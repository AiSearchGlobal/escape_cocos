"use strict";
cc._RF.push(module, '53c55vfovlCBI6+FHhjmumL', 'VMProgress');
// script/framework/component/VMProgress.ts
...
var StringFormat_1 = require("../core/StringFormat");
...
var VMProgress = /** @class */ (function (_super) {
    ...
    VMProgress.prototype.onLoad = function () {
        ...
        if (this.watchPathArr.length < 2 || this.watchPathArr[0] == '[min]' || this.watchPathArr[1] == '[max]') {
            Log_1.Log.error('VMProgress must have two values!');
        }
