"use strict";
cc._RF.push(module, '0cee0I1ITJM052iCnpfRV7g', 'StringFormat');
// script/framework/core/StringFormat.ts
...
var StringFormat = /** @class */ (function () {
    ...
    StringFormat.prototype.fix = function (value, fd) {
        var re = new RegExp("([0-9]+\\.[0-9]{" + fd + "})[0-9]*");
        var aNew = value.toString().replace(re, "$1");
        return parseFloat(aNew).toFixed(fd);
    };
